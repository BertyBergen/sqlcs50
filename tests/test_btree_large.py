...
class TestBtreeLarge(unittest.TestCase):
    def test_structure_of_four_leaf_node_btree(self):
            script = [
            ...
            result = run_script(script, test_name, "test_structure_of_four_leaf_node_btree")
            expected_output = [
                "sqlcs50> Executed.",
                "sqlcs50> Executed.",
                "sqlcs50> Executed.",
                ...
                "sqlcs50> Executed.",
                "sqlcs50> Executed.",
                "sqlcs50> Error: Old key not found in the internal node.",
                "sqlcs50> Executed.",
                "sqlcs50> Tree:",
                "- internal (size 3)",
                "- leaf (size 7)",
            ...
            print("_JOPAAAAAAAAAA____________________________________")
            print("\n".join(result))
            print("_JOPAAAAAAAAAA____________________________________")
            self.assertEqual(result, expected_output)

    def test_print_structure_of_seven_leaf_node_btree(self):
        script = [
