...
class TestBtreeLarge(unittest.TestCase):
    def test_four_leaf_node_btree(self):
            script = [
            ...
            result = run_script(script, test_name, "test_four_leaf_node_btree")
            expected_output = ["sqlcs50> Executed."] * 30
            expected_output += [
                "sqlcs50> Tree:",
                "- internal (size 3)",
                "- leaf (size 7)",
    ...
    def test_seven_leaf_node_btree(self):
            script = [
